...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <section className="relative overflow-hidden bg-slate-50 pt-32 pb-40 border-b border-blue-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-blue-200 text-indigo-700 text-sm font-medium mb-8 shadow-sm"
          >
          ...
          >
            <Link href="/quote" className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold rounded-full text-slate-900 bg-gradient-to-r from-rose-500 to-rose-600 hover:from-rose-400 hover:to-rose-500 transition-all shadow-lg shadow-rose-500/30 hover:scale-105 active:scale-95 group">
              Calculate Freight
            ...
            <button 
              ...
              className="inline-flex items-center justify-center px-8 py-4 text-lg font-bold rounded-full text-slate-700 bg-white border border-blue-200 hover:border-blue-200 hover:bg-slate-50 shadow-sm transition-all hover:scale-105 active:scale-95"
            >
              Track Shipment
            </button>
          </motion.div>
      ...
      {/* Partners Marquee */}
      <div className="bg-white border-b border-blue-200 overflow-hidden relative z-20 py-4 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex gap-8 md:gap-16 items-center justify-center flex-wrap opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
             {['Acme Corp', 'GlobalTech', 'Nexus', 'Stark Ind.', 'Wayne Ent.', 'Cyberdyne'].map((partner, i) => (
                <div key={i} className="text-xl font-black text-slate-600 tracking-tighter flex items-center">
      ...
      <section id="tracking-section" className="relative -mt-16 z-30 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div 
          ...
          className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-blue-200/50"
        >
          ...
          <form onSubmit={handleTrack} className="flex flex-col md:flex-row gap-4">
            <div className="flex-grow relative">
              ...
              <input 
                ...
                className="w-full bg-slate-50 border border-blue-200 rounded-xl pl-12 pr-5 py-4 text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-lg uppercase tracking-wider shadow-inner transition-all"
              />
            </div>
            <button 
              type="submit"
              ...
              >
                <div className="bg-white border border-blue-200 rounded-2xl p-6 shadow-sm">
                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-6">
                    ...
                    <div className="text-left md:text-right bg-slate-50 p-3 rounded-lg border border-blue-100 w-full md:w-auto">
                      ...
                      <p className="font-bold text-slate-900 text-lg flex items-center justify-start md:justify-end">
                        <Clock className="w-4 h-4 mr-1 text-slate-600" /> {trackingResult.eta}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 text-center border-t border-blue-100 pt-4">
      ...
      <section className="py-24 bg-white relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={itemVariants} className="p-6 rounded-2xl bg-slate-50 border border-blue-100 hover:border-blue-200 transition-colors">
      ...
      <section className="py-24 bg-slate-50 border-t border-blue-200 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* API Integration */}
            <motion.div whileHover={{ y: -5 }} className="bg-white p-8 rounded-3xl shadow-sm border border-blue-100 hover:shadow-xl transition-all group relative overflow-hidden">
              <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity">
                <Zap className="w-32 h-32" />
              </div>
              <div className="w-16 h-16 bg-white text-slate-900 rounded-2xl flex items-center justify-center mb-8 shadow-md">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-slate-50 p-8 rounded-2xl border border-blue-100 relative">
      ...
      <section className="py-20 bg-indigo-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h2 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-6">Ready to Modernize Your Logistics?</h2>
