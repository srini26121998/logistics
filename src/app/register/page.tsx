    ...
    >
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-2">
          <div className={`h-2 flex-1 rounded-full transition-colors duration-500 ${step >= 1 ? 'bg-blue-600' : 'bg-slate-800'}`}></div>
          <div className={`h-2 flex-1 rounded-full transition-colors duration-500 ${step >= 2 ? 'bg-blue-600' : 'bg-slate-800'}`}></div>
        </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="relative group">
                  <input
                    type="text"
                    required
                    className="block w-full px-4 py-3 bg-slate-900/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all outline-none"
              ...
              <div className="flex items-start gap-3 text-sm mt-4">
                <div className="relative flex items-center justify-center w-5 h-5 mt-0.5">
                  <input
                    type="checkbox"
                    required
                    className="peer appearance-none w-5 h-5 border border-slate-700 rounded bg-slate-900/50 checked:bg-blue-600 checked:border-blue-600 transition-colors cursor-pointer"
                  />
